...
#
# Usage:
#  sh ./raijin_install.sh <destfolder> [branch]
#
...
BRANCH=${2-master} # use master branch as default
...
cd $UW_DIR
git checkout $BRANCH  # checkout the requested version
...
pip3 install git+https://github.com/underworldcode/uwgeodynamics@$BRANCH --prefix=$INSTALLPATH
